...
const urduDictionary: { [key: string]: string } = {
    ...
    "Node.js": "نوڈ.جی ایس", // Proper noun, often transliterated or kept as is
    css: "سی ایس ایس",
    flexbox: "فلیکس باکس",
    layout: "لے آؤٹ",
    module: "ماڈیول",
    ...
    "20": "۲۰",
    "04": "۰۴",
    // --- Common Phrases (add more as needed) ---
    ...
    autoperfixer: "آٹوپریفکسر", // Transliteration for a tool name
};
